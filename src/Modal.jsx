...
import AccessibilityFeedback from './AccessibilityFeedback'; // 导入新组件
        ...
        >
          ...
          <div className='bg-white outline-none focus:outline-none overflow-scroll rounded-2xl my-12 relative'>
            ...
            <div className='p-6'>
              ...
              <div>
                <MapboxTooltip title='无障碍信息反馈' className='mb-3'>
                {`
请在此处提供您的反馈或建议。我们非常重视您的意见，并将其用于改进我们的服务。
`}
                </MapboxTooltip>
                <AccessibilityFeedback /> {/* 使用新组件 */}
              </div>
              <br />
              <div>
